 ...
 * GitHub repo is still private, or fully offline. Keep this in sync with
 * manifest/axo-manifest.json (the release pipeline is the source of truth);
 * a stale fallback still lets the launcher open and show a version, and the
 * next successful online fetch overwrites it.
 */
